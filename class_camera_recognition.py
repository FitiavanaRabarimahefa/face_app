...
def create_camera_app(encodings_path):
    encoding_dict = load_pickle(f"{encodings_path}")
...
class FaceRecognition:
    def __init__(self, encodings_path, session):
        self.encodings_path = encodings_path
        self.session = session

    def open_camera_app(self):
        return create_camera_app(self.encodings_path)


"""
face01 = FaceRecognition('encodings/encodings.pkl', 10)
face01.open_camera_app()
"""
